...
return new class extends Migration
{
    ...
    {
        Schema::create('programs_btled', function (Blueprint $table) {
            $table->id();
            $table->string('hero_image')->nullable();
            $table->string('hero_title')->default('Bachelor of Technology and Livelihood Education (BTLED)');
    ...
    {
        Schema::dropIfExists('programs_btled');
    }
};
