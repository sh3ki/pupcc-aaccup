...
use App\Models\Landing\AboutBsent;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Facades\Log;
use Inertia\Inertia;

class AboutBsentController extends Controller
{
    /**
     * Display the admin layout BSENT page
     */
    public function index()
    {
        $content = AboutBsent::getContent();
        
        return Inertia::render('admin/layout/AboutBSENT', [
    ...
    public function update(Request $request)
    {
        try {
            ...
            if ($request->hasFile('hero_image')) {
                ...
                $path = $file->store('landing/bsent/hero', 'public');
            ...
            if ($request->has('faculty_data')) {
                ...
                foreach ($facultyItems as $index => $item) {
                    ...
                    if ($request->hasFile("faculty_image_{$index}")) {
                        ...
                        $path = $file->store('landing/bsent/faculty', 'public');
            ...
            if ($request->hasFile('mula_sayo_image')) {
                ...
                $path = $file->store('landing/bsent/mula_sayo', 'public');
            ...
            Log::error('Failed to update BSENT content: ' . $e->getMessage());
    ...
    /**
     * Display the landing BSENT page with dynamic content
     */
    public function show()
    {
        ...
        return Inertia::render('landing/about/bsent', [
