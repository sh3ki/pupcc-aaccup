...
class ExhibitObeSyllabiController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('program1_image')) {
            ...
            $data['program1_image'] = $request->file('program1_image')->store('exhibit/obe-syllabi/program1', 'public');
        }
        ...
        if ($request->hasFile('program2_image')) {
            ...
            $data['program2_image'] = $request->file('program2_image')->store('exhibit/obe-syllabi/program2', 'public');
        }
        ...
        if ($request->hasFile('program3_image')) {
            ...
            $data['program3_image'] = $request->file('program3_image')->store('exhibit/obe-syllabi/program3', 'public');
        }
