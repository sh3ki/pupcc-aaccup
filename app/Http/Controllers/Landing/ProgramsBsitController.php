...
class ProgramsBsitController extends Controller
{
  ...
  if ($request->has('accreditation_section_title')) {
    ...
    {
        Log::info('BSIT getDocumentsForApi called', [
        ...
        if ($isSpecialParameter) {
            ...
            Log::info('BSIT Special documents found', [
            ...
            Log::info('BSIT Regular documents found', [
                'count' => $documents->count()
            ]);
        ...
        Log::info('BSIT Transformed documents', ['count' => $transformedDocuments->count()]);
