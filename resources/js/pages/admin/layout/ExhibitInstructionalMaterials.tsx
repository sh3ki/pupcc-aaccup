...
export default function LayoutExhibitInstructionalMaterials({ instructionalMaterialsContent }: Props) {
    ...
    const [heroSubtitle, setHeroSubtitle] = useState(instructionalMaterialsContent.hero_subtitle || 'Educational resources and teaching materials for program delivery');
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                {activeSection === 'materials' && (
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#7F0404] mb-4">Instructional Materials</h3>
                                        <div className="space-y-6">
                                            <div>
