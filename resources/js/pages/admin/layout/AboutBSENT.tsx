...
export default function AboutBsent({ bsentContent }: Props) {
    ...
    // Hero Section State
    const [heroTitle, setHeroTitle] = useState(bsentContent.hero_title || 'BSENT Faculty');
    const [heroSubtitle, setHeroSubtitle] = useState(bsentContent.hero_subtitle || 'Bachelor of Science in Entrepreneurship');
    const [heroImage, setHeroImage] = useState<string | File>(bsentContent.hero_image || '');

    // Faculty Section State
    const [facultySectionTitle, setFacultySectionTitle] = useState(bsentContent.faculty_section_title || 'Faculty Members');
    const [faculty, setFaculty] = useState<FacultyItem[]>(
        bsentContent.faculty_data && bsentContent.faculty_data.length > 0 
            ? bsentContent.faculty_data 
            : [{ image: '', name: '' }]
    );
    ...
    const handleSave = () => {
        ...
        router.post('/admin/layout/about/bsent', formData, {
            forceFormData: true,
                ...
                <div className="flex w-full h-[calc(100vh-64px-40px)]">
                    ...
                    <aside className="w-1/4 bg-white border-r border-gray-200 h-full sticky top-16 self-start overflow-y-auto">
                        <div className="p-6">
                            {/* Header */}
                            <div className="mb-6">
                                <h2 className="text-xl font-bold text-gray-800">BSENT Faculty Page Editor</h2>
                    ...
                    <section className="flex-1 w-full px-8 py-4 pb-2 text-left flex flex-col h-full">
                        ...
                        <div className="flex justify-between items-center mb-4 flex-shrink-0">
                            <div>
                                <h1 className="text-2xl font-bold text-gray-800">BSENT Faculty Page Preview</h1>
                        ...
                        <div className="flex-1 min-h-0 flex justify-center">
                            <div className="h-full w-full max-w-7xl">
                                <PagePreview 
                                    pageUrl="/faculty/bsent" 
                                    title="BSENT Faculty Page Preview"
                                    key={previewKey}
                                />
                            </div>
                        </div>
