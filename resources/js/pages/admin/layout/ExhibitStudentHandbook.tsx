...
export default function LayoutExhibitStudentHandbook({ studentHandbookContent }: Props) {
    ...
    // Hero Section State
    const [heroTitle, setHeroTitle] = useState(studentHandbookContent.hero_title || "Student Handbook");
    const [heroSubtitle, setHeroSubtitle] = useState(studentHandbookContent.hero_subtitle || 'Comprehensive guide for student policies and procedures');
    ...
    const [footerSectionTitle, setFooterSectionTitle] = useState(studentHandbookContent.footer_section_title || 'Mula Sayo, Para Sa Bayan');
    const [footerImage, setFooterImage] = useState<string | File>(studentHandbookContent.footer_image || '');
    ...
    const handleSave = () => {
        ...
        // Add handbook document
        if (handbookDocument instanceof File) {
        ...
        router.post('/admin/layout/exhibit/student-handbook', formData, {
            forceFormData: true,
    ...
    const sections = [
        ...
        { id: 'handbook', name: 'Handbook Document' },
        { id: 'footer', name: 'Mula Sayo' }
    ];

    return (
        <>
            <Head title="Layout: Exhibit - Student Handbook" />
            <DashboardLayout>
                <div className="flex w-full h-[calc(100vh-64px-40px)]">
                    ...
                    <aside className="w-1/4 bg-white border-r border-gray-200 h-full sticky top-16 self-start overflow-y-auto">
                        <div className="p-6">
                            {/* Header */}
                            <div className="mb-6">
                                <h2 className="text-xl font-bold text-gray-800">Student Handbook Page Editor</h2>
                            ...
                            <div className="space-y-6">
                                ...
                                {/* Handbook Document Section */}
                                {activeSection === 'handbook' && (
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#7F0404] mb-4">Handbook Document</h3>
                                        <div className="space-y-4">
                                            <div>
                                            ...
                                            <FileUpload
                                                ...
                                                value={handbookDocument}
                                                onChange={(file) => setHandbookDocument(file || '')}
                                            ...
                                            <p className="text-xs text-gray-500 mt-1">
                                                Upload handbook document (Image, PDF, DOC, or DOCX)
                                            </p>
                                        </div>
                                    </div>
                                )}
                    ...
                    <section className="flex-1 w-full px-8 py-4 pb-2 text-left flex flex-col h-full">
                        ...
                        <div className="flex justify-between items-center mb-4 flex-shrink-0">
                            <div>
                                <h1 className="text-2xl font-bold text-gray-800">Student Handbook Page Preview</h1>
                        ...
                        <div className="flex-1 min-h-0 flex justify-center">
                            <div className="h-full w-full max-w-7xl">
                                <PagePreview 
                                    pageUrl="/exhibit/student-handbook" 
                                    title="Student Handbook Page Preview"
                                    key={previewKey}
                                />
                            </div>
                        </div>
