...
const program = {
    name: 'Bachelor of Science in Entrepreneurship (BSENT)',
    heroImage: '/api/placeholder/1600/600',
    overview: 'The BSENT program nurtures innovative and entrepreneurial mindsets, preparing students to launch and manage successful business ventures.',
    objectives: [
...
export default function BSENTProgramPage() {
                ...
                <main className="pt-16 sm:pt-20">
                    ...
                    >
                        ...
                        <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 relative z-10">
                            ...
                            <div className="flex-1">
                                <img src="/api/placeholder/500/400" alt="BSENT Overview" className="rounded-2xl shadow-lg w-full object-cover" style={{ minHeight: 260, maxHeight: 400 }} />
                            </div>
                        </div>
                    </section>
