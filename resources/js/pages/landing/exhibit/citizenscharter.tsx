...
export default function CitizensCharter({ charterContent }: Props) {
    // Use proper placeholder URLs that actually work
    const charterUrl = charterContent.charter_document || "https://via.placeholder.com/900x1200/f3f4f6/6b7280?text=Charter+Preview";
    
    // Hero Section Data
    const heroImageUrl = charterContent.hero_image || "https://via.placeholder.com/1600x500/7f0404/ffffff?text=Citizens+Charter+Hero+Image";
    
    // Footer Section Data  
    const footerImageUrl = charterContent.footer_image || "https://via.placeholder.com/1600x400/7f0404/ffffff?text=Footer+Background";
    ...
    useEffect(() => {
        if (charterContent.charter_document && isPDF(charterContent.charter_document) && !pdfLoaded) {
            setPdfLoaded(true);
        }
    }, [charterContent.charter_document, pdfLoaded]);

    // Charter Display Component - moved outside of animation effects
    const CharterDisplay = useCallback(() => {
        // Check if we have a real charter (not placeholder)
        const hasRealCharter = charterContent.charter_document && 
                              !charterContent.charter_document.includes('placeholder');
            ...
            return (
                <div className="flex flex-col items-center justify-center min-h-[400px] bg-gray-100 rounded-xl border border-gray-200">
                    <div className="text-center">
                        ...
                        <p className="text-gray-500 font-medium">No charter uploaded</p>
                        <p className="text-gray-400 text-sm">Upload a charter via the admin panel</p>
                    </div>
                </div>
            );
        }

        if (isPDF(charterContent.charter_document || '') && pdfLoaded) {
            return (
                <div className="w-full">
                    ...
                    <div className="w-full max-w-4xl mx-auto rounded-xl border border-gray-200 overflow-hidden" style={{ height: '800px' }}>
                        <PdfViewer
                            url={charterContent.charter_document || ''}
                    ...
                    <div className="mt-4 text-center">
                        <a
                            href={charterContent.charter_document}
                            target="_blank"
        ...
        } else if (isPDF(charterContent.charter_document || '') && !pdfLoaded) {
        ...
        if (isImage(charterContent.charter_document || '')) {
            return (
                <div className="w-full max-w-4xl mx-auto bg-gray-50 flex items-center justify-center rounded-xl border border-gray-200 overflow-hidden" style={{ minHeight: '400px' }}>
                    <img
                        src={charterContent.charter_document}
                        alt="Charter"
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] bg-gray-100 rounded-xl border border-gray-200">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 text-sm mb-4">Click to download: {getFileExtension(charterUrl).toUpperCase()} file</p>
                    <a
                        href={charterUrl}
                        download
    ...
    }, [charterContent.charter_document, pdfLoaded, currentPage, setTotalPages, zoom, rotate, charterUrl]);
    
    // Animation hooks for different sections
    const [heroRef, heroVisible] = useScrollAnimation();
    const [charterRef, charterVisible] = useScrollAnimation();
            ...
            <div className="min-h-screen bg-white overflow-x-hidden">
                            ...
                            <div className={`bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl border-t-4 transition-all duration-1000 delay-200 ${
                                ...
                                <div className="p-8 sm:p-12 flex flex-col items-center">
                                    <h2 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-8 sm:mb-12 text-center transition-all duration-1000 delay-400 ${
                                        ...
                                        {charterContent.section_title}
                                    </h2>
                                    {/* Charter Display with PDF Support */}
                ...
                <section className="relative py-16 sm:py-20 lg:py-24 px-0 transition-all duration-1200">
                    <div className="absolute inset-0 w-full h-full">
                        <img
                            src={footerImageUrl}
                            alt={charterContent.footer_section_title}
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center h-full">
                        <h2 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white text-shadow-lg mb-4 animate-fade-in-up">
                            {charterContent.footer_section_title}
                        </h2>
                    </div>
                </section>
