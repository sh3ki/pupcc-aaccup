...
export default function ChedMemorandumOrder({ chedMemorandumOrderContent }: Props) {
    ...
    // Hero Section Data
    const heroImageUrl = chedMemorandumOrderContent.hero_image || "https://via.placeholder.com/1600/500/7f0404/ffffff?text=CHED+Memorandum+Order+Hero+Image";
    
    // Footer Section Data  
    const footerImageUrl = chedMemorandumOrderContent.footer_image || "https://via.placeholder.com/1600/400/7f0404/ffffff?text=Footer+Background";

    // Programs data
    const programs = useMemo(() => [
        {
            id: 1,
            title: chedMemorandumOrderContent.program1_title,
            image: chedMemorandumOrderContent.program1_image || "https://via.placeholder.com/600/400/7f0404/ffffff?text=Program+1",
            document: chedMemorandumOrderContent.program1_document
        },
        {
            id: 2,
            title: chedMemorandumOrderContent.program2_title,
            image: chedMemorandumOrderContent.program2_image || "https://via.placeholder.com/600/400/7f0404/ffffff?text=Program+2",
            document: chedMemorandumOrderContent.program2_document
        },
        {
            id: 3,
            title: chedMemorandumOrderContent.program3_title,
            image: chedMemorandumOrderContent.program3_image || "https://via.placeholder.com/600/400/7f0404/ffffff?text=Program+3",
            document: chedMemorandumOrderContent.program3_document
        }
    ], [chedMemorandumOrderContent]);
