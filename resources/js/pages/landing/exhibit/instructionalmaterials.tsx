...
export default function InstructionalMaterials({ instructionalMaterialsContent }: Props) {
    ...
    // Hero Section Data
    const heroImageUrl = instructionalMaterialsContent.hero_image || "https://via.placeholder.com/1600/500/7f0404/ffffff?text=Instructional+Materials+Hero+Image";
    
    // Footer Section Data  
    const footerImageUrl = instructionalMaterialsContent.footer_image || "https://via.placeholder.com/1600/400/7f0404/ffffff?text=Footer+Background";

    // Programs data
    const programs = useMemo(() => [
        {
            id: 1,
            title: instructionalMaterialsContent.program1_title,
            image: instructionalMaterialsContent.program1_image || "https://via.placeholder.com/600/400/7f0404/ffffff?text=Program+1",
            documents: instructionalMaterialsContent.program1_documents || []
        },
        {
            id: 2,
            title: instructionalMaterialsContent.program2_title,
            image: instructionalMaterialsContent.program2_image || "https://via.placeholder.com/600/400/7f0404/ffffff?text=Program+2",
            documents: instructionalMaterialsContent.program2_documents || []
        },
        {
            id: 3,
            title: instructionalMaterialsContent.program3_title,
            image: instructionalMaterialsContent.program3_image || "https://via.placeholder.com/600/400/7f0404/ffffff?text=Program+3",
            documents: instructionalMaterialsContent.program3_documents || []
        }
    ], [instructionalMaterialsContent]);
