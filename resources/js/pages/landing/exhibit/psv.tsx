...
export default function Psv({ psvContent }: Props) {
    ...
    // Hero Section Data
    const heroImageUrl = psvContent.hero_image || "https://via.placeholder.com/1600/500/7f0404/ffffff?text=PSV+Hero+Image";
    
    // Footer Section Data  
    const footerImageUrl = psvContent.footer_image || "https://via.placeholder.com/1600/400/7f0404/ffffff?text=Footer+Background";

    // Programs data
    const programs = useMemo(() => [
        {
            id: 1,
            title: psvContent.program1_title,
            image: psvContent.program1_image || "https://via.placeholder.com/600/400/7f0404/ffffff?text=Program+1",
            document: psvContent.program1_document
        },
        {
            id: 2,
            title: psvContent.program2_title,
            image: psvContent.program2_image || "https://via.placeholder.com/600/400/7f0404/ffffff?text=Program+2",
            document: psvContent.program2_document
        },
        {
            id: 3,
            title: psvContent.program3_title,
            image: psvContent.program3_image || "https://via.placeholder.com/600/400/7f0404/ffffff?text=Program+3",
            document: psvContent.program3_document
        }
    ], [psvContent]);
