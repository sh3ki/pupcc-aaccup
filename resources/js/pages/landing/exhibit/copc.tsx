...
export default function Copc({ copcContent }: Props) {
    ...
    return (
        <>
            <Head title="COPC - Certificate of Program Compliance" />
            <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50">
                ...
                <section 
                    ...
                    style={{
                        background: copcContent.hero_image
                            ? `linear-gradient(135deg, rgba(127, 4, 4, 0.85) 0%, rgba(77, 20, 20, 0.85) 50%, rgba(196, 107, 2, 0.85) 100%), url(${copcContent.hero_image})`
                ...
                {copcContent.copc_document && (
                    ...
                    >
                        <div className="max-w-7xl mx-auto">
                            ...
                            {isPDF(copcContent.copc_document) ? (
                            ...
                            ) : isImage(copcContent.copc_document) ? (
                ...
                <section 
                    ...
                    style={{
                        background: copcContent.footer_image
                            ? `linear-gradient(135deg, rgba(127, 4, 4, 0.9) 0%, rgba(196, 107, 2, 0.9) 100%), url(${copcContent.footer_image})`
