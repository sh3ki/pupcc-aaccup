        ...
        <>
            ...
            >
                ...
                <input
                    ...
                    className="w-8 text-center rounded bg-white text-[#7F0404] font-bold mx-1 border border-gray-200 shadow-sm"
                    style={{ height: 20, fontSize: 12 }} // Reduced from 28 to 24
                    disabled={documents.length === 0}
                />
                <span className="text-xs" style={{ color: '#F8F8F8' }}>{`/ ${documents.length || 1}`}</span>
                ...
                <form className="flex items-center" onSubmit={onSearch}>
                    <input
                        ...
                        className="rounded px-2 py-0.5 text-xs bg-white text-[#7F0404] placeholder-[#C46B02] border border-gray-200 shadow-sm focus:ring-1 focus:ring-[#FFD600] focus:outline-none"
                        style={{ width: 150, height: 24 }} // Reduced from 28 to 24
                    />
                    <button type="submit" className="ml-1 hover:bg-[#FFD600]/20 p-0.5 rounded transition" title="Search">
                        <svg className="w-4 h-4" fill="none" stroke="#F8F8F8" strokeWidth={2} viewBox="0 0 24 24">
                            <circle cx="11" cy="11" r="8" />
